...
import type { ArrivalTimeFilter } from "@/app/types/filters.types";

type ArrivalTimingFilterProps = {
  toCity?: string;
  value: ArrivalTimeFilter;
  onChange: (value: ArrivalTimeFilter) => void;
};

export default function ArrivalTimingFilter({
  toCity,
  value,
  onChange,
}: ArrivalTimingFilterProps) {
  const base =
